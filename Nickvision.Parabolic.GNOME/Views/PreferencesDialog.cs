...
public class PreferencesDialog : Adw.PreferencesDialog
{
    ...
    private async void Dialog_OnClosed(Adw.Dialog sender, EventArgs args)
    {
        ...
        _controller.IncludeMediaIdInTitle = _controller.IncludeMediaIdInTitle;
        _controller.IncludeAutoGeneratedSubtitles = _controller.IncludeAutoGeneratedSubtitles;
