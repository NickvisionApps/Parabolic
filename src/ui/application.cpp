...
Application::Application(const std::string& id, GApplicationFlags flags) : m_adwApp{ adw_application_new(id.c_str(), flags) }
{
    ...
    m_appInfo.setVersion("2022.10.2-beta2");
    m_appInfo.setChangelog("<ul><li>New application icon (Thanks @martin-desktops!)</li><li>Implemented proper stop function for download</li><li>Improved video url checking</li></ul>");
