...
namespace Nickvision::TubeConverter::GNOME::Views
{
        ...
        m_controller{ controller }
    {
        ...
        adw_switch_row_set_active(ADW_SWITCH_ROW(gtk_builder_get_object(m_builder, "disallowConversionsRow")),options.getDisallowConversions());
    ...
    void PreferencesDialog::onClosed()
    {
        ...
        options.setDisallowConversions(adw_switch_row_get_active(ADW_SWITCH_ROW(gtk_builder_get_object(m_builder, "disallowConversionsRow"))));
