...
namespace Nickvision::TubeConverter::GNOME::Views
{
        ...
        m_controller{ controller }
    {
        ...
        adw_switch_row_set_active(m_builder.get<AdwSwitchRow>("recoverCrashedDownloadsRow"), options.getRecoverCrashedDownloads());
    ...
    void PreferencesDialog::onClosed()
    {
        ...
        options.setRecoverCrashedDownloads(adw_switch_row_get_active(m_builder.get<AdwSwitchRow>("recoverCrashedDownloadsRow")));
