...
Parabolic is built using C++20 and platform-native user interface libraries. With these technologies, Parabolic is built for both GNOME (Linux) and Windows.
