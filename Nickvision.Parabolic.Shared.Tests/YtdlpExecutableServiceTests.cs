...
public sealed class YtdlpExecutableServiceTests
{
    ...
    [TestMethod]
    public void Case002_BundledVersionCheck() => Assert.AreEqual(new AppVersion("2026.02.21"), _ytdlpExecutableService!.BundledVersion);
    ...
    public async Task Case005_DownloadLatestStableVersion()
    {
        ...
        Assert.AreEqual(new AppVersion("2026.02.21"), stable);
