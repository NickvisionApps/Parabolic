...
public class Configuration
{
    ...
    public DownloaderOptions DownloaderOptions
    {
        ...
        set
        {
            MaxNumberOfActiveDownloads = value.MaxNumberOfActiveDownloads;
            OverwriteExistingFiles = value.OverwriteExistingFiles;
            LimitCharacters = value.LimitCharacters;
            IncludeMediaIdInTitle = value.IncludeMediaIdInTitle;
            IncludeAutoGeneratedSubtitles = value.IncludeAutoGeneratedSubtitles;
            PreferredVideoCodec = value.PreferredVideoCodec;
            PreferredAudioCodec = value.PreferredAudioCodec;
            PreferredSubtitleFormat = value.PreferredSubtitleFormat;
            UsePartFiles = value.UsePartFiles;
            YouTubeSponsorBlock = value.YouTubeSponsorBlock;
            SpeedLimit = value.SpeedLimit;
            ProxyUrl = value.ProxyUrl;
            CookiesBrowser = value.CookiesBrowser;
            CookiesPath = value.CookiesPath;
            EmbedMetadata = value.EmbedMetadata;
            RemoveSourceData = value.RemoveSourceData;
            EmbedThumbnails = value.EmbedThumbnails;
            CropAudioThumbnails = value.CropAudioThumbnails;
            EmbedChapters = value.EmbedChapters;
            EmbedSubtitles = value.EmbedSubtitles;
            PostprocessingThreads = value.PostprocessingThreads;
            PostprocessingArguments = value.PostprocessingArguments;
            UseAria = value.UseAria;
            AriaMaxConnectionsPerServer = value.AriaMaxConnectionsPerServer;
            AriaMinSplitSize = value.AriaMinSplitSize;
        }
    }
}
