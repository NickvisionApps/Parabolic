...
public class DownloaderOptions
{
    ...
    public override int GetHashCode() => HashCode.Combine(
        HashCode.Combine(MaxNumberOfActiveDownloads, OverwriteExistingFiles, LimitCharacters, IncludeMediaIdInTitle, IncludeAutoGeneratedSubtitles, IncludeSuperResolutions, PreferredVideoCodec, PreferredAudioCodec),
        HashCode.Combine(PreferredSubtitleFormat, PreferredFrameRate, UsePartFiles, YouTubeSponsorBlock, SpeedLimit, ProxyUrl, CookiesBrowser, CookiesPath),
        HashCode.Combine(EmbedMetadata, RemoveSourceData, EmbedThumbnails, CropAudioThumbnails, EmbedChapters, EmbedSubtitles, PostprocessingThreads, UseAria),
        HashCode.Combine(AriaMaxConnectionsPerServer, YtdlpDiscoveryArgs, YtdlpDownloadArgs),
        AriaMinSplitSize);
}
