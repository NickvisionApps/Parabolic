...
public class DownloaderOptions
{
    ...
    public override int GetHashCode() => HashCode.Combine(
        ...
        HashCode.Combine(PreferredFrameRate, UsePartFiles, YouTubeSponsorBlock, SpeedLimit, ProxyUrl, CookiesBrowser, CookiesPath, EmbedMetadata),
        HashCode.Combine(RemoveSourceData, EmbedThumbnails, CropAudioThumbnails, EmbedChapters, EmbedSubtitles, PostprocessingThreads, UseAria, AriaMaxConnectionsPerServer),
        HashCode.Combine(YtdlpDiscoveryArgs, YtdlpDownloadArgs),
        AriaMinSplitSize);
}
