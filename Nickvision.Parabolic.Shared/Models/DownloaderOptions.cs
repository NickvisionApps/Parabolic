...
public class DownloaderOptions
{
    ...
    public override int GetHashCode() => HashCode.Combine(
        HashCode.Combine(MaxNumberOfActiveDownloads, OverwriteExistingFiles, LimitCharacters, IncludeMediaIdInTitle, IncludeAutoGeneratedSubtitles, IncludeSuperResolutions, PreferredVideoCodec, PreferredVideoCodec),
