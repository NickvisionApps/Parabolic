...
public sealed partial class SettingsPage : Page
{
    ...
    private async void EditPostprocessingArgument(object? sender, RoutedEventArgs e)
    {
        ...
        CmbPostprocessingArgumentPostProcessor.SelectedItem = (CmbPostprocessingArgumentPostProcessor.ItemsSource as IReadOnlyList<SelectionItem<PostProcessor>>)!.First(x => x.Value == argument.PostProcessor);
    ...
    private async Task ApplyChangesAsync()
    {
        ...
        _controller.PreferredVideoCodec = (CmbPreferredVideoCodec.SelectedItem as SelectionItem<VideoCodec>)!.Value;
        _controller.PreferredAudioCodec = (CmbPreferredAudioCodec.SelectedItem as SelectionItem<AudioCodec>)!.Value;
        _controller.PreferredSubtitleFormat = (CmbPreferredSubtitleFormat.SelectedItem as SelectionItem<SubtitleFormat>)!.Value;
        ...
        _controller.CookiesBrowser = (CmbCookiesBrowser.SelectedItem as SelectionItem<Browser>)!.Value;
