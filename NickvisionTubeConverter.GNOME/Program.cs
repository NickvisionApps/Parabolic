...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Version = "2023.7.2-next";
        _mainWindowController.AppInfo.Changelog = "<ul><li>Added the ability to select a download's audio language if more than one are available</li><li>Added the option to allow only Windows-supported characters in filenames</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
