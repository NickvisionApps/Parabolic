...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Added the ability to upload a cookie file to use for media downloads that require a login</li><li>Added support for downloading media as M4A</li><li>Added more configurable options for aria2 downloader</li><li>Added the ability to clear completed downloads</li><li>Tube Converter will check the clipboard for a valid media url on startup and when AddDownloadDialog is opened</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
