...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Version = "2023.6.3";
        _mainWindowController.AppInfo.Changelog = "<ul><li>Tube Converter has been renamed. Introducing, Parabolic!</li><li>Fixed a large memory leak caused by not disposing logs correctly</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
