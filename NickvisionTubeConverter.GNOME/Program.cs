...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Version = "2023.7.3-beta1";
        _mainWindowController.AppInfo.Changelog = "<ul><li>Improved Keyring Dialog design</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
