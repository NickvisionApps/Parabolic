...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Recently completed downloads will be shown first in the completed group instead of being appended last</li><li>Fixed a performance issue with displaying logs when the logs were large in size</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
