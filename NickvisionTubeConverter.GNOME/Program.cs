...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Added username and password fields to authenticate when adding a download</li><li>The \"Number Titles\" switch's state will now be remembered and used again for future downloads</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
