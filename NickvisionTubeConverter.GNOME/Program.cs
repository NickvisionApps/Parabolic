...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Fixed a random crash users where experiencing when downloading</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
