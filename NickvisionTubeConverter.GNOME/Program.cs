...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Added the ability to stop all downloads</li><li>Added the ability to retry all failed downloads</li><li>Fixed a random crash users where experiencing when downloading</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
