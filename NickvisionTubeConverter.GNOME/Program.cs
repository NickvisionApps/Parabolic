...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Added username and password fields in Advanced Options for a download</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
