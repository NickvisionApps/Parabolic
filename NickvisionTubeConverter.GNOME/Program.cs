...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Added the ability to upload a cookie file to use for media downloads that require a login<li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
