...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Fixed an issue where embedding metadata would cause some downloads to fail</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
